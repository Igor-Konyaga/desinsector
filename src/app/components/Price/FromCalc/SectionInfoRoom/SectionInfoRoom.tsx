...
import {InputInfoRoom} from "@/app/components/Price/FromCalc/InputInfoRoom/InputInfoRoom";
...
export const SectionInfoRoom = ({
    ...
    return (
        <div className={styles.roomInfo}>
            <InputInfoRoom label="Розмір приміщення (м²):" disabled={resultPrice > 0} type="number" name="areaRoom"
                           id="areaRooms" onChange={handleChangeSquareMeter} value={squareMeter}/>
